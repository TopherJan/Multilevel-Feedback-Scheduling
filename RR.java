...
public class RR {
  ...
  public RR(int[] process, int[] arrivalTime, int[] burstTime, int[] priority, int size, int q){
  /*
	...
	*/
	...
	CPUFrame.processLabel = new JLabel[t.size()];
	GanttThread ppt = new GanttThread(p, t);
